...
For this review, expand to `docs/semantics.md` when needed to verify timing correctness, self-time rules, mismatch repair, MPI semantics, or OpenMP guard behavior.