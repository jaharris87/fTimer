...
- Explicit opt-in OpenMP worker timing through `ftimer_openmp_t`, with local OpenMP summaries/reports and strict MPI+OpenMP hybrid summaries/reports/CSV when initialized with `comm=`
