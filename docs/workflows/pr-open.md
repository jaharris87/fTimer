...
- After a later push, remember that automatic rerouting stops; if the diff meaning changed, reconcile the labels manually so `Codex Review Coverage` reflects the current PR head honestly.
