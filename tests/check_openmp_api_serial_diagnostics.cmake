...
if(NOT DEFINED TEST_EXECUTABLE OR TEST_EXECUTABLE STREQUAL "")
  message(FATAL_ERROR "TEST_EXECUTABLE must point to ftimer_openmp_api_serial_diagnostics.")
endif()
...
if(NOT diagnostic_result EQUAL 0)
  message(FATAL_ERROR
    "ftimer_openmp_api_serial_diagnostics exited with a nonzero status.\n"
    "stdout:\n${diagnostic_stdout}\n"
    "stderr:\n${diagnostic_stderr}"
  )
endif()
...
if(NOT diagnostic_stderr_normalized STREQUAL expected_stderr)
  message(FATAL_ERROR
    "Unexpected ftimer_openmp serial diagnostic stderr.\n"
    "Expected:\n${expected_stderr}\n"
