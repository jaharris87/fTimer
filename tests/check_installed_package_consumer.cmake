...
get_filename_component(test_fortran_compiler_name "${test_fortran_compiler}" NAME)
set(ftimer_provider_mpiexec_names mpiexec mpirun)
if(test_fortran_compiler_name MATCHES "mpich")
  set(ftimer_provider_mpiexec_names mpiexec.mpich mpirun.mpich mpiexec mpirun)
elseif(test_fortran_compiler_name MATCHES "openmpi")
  set(ftimer_provider_mpiexec_names mpiexec.openmpi mpirun.openmpi mpiexec mpirun)
endif()
...
if(TEST_ENABLE_MPI)
  ...
  if(DEFINED TEST_MPIEXEC_EXECUTABLE AND NOT TEST_MPIEXEC_EXECUTABLE STREQUAL "")
    ...
    find_program(ftimer_mpiexec NAMES ${ftimer_provider_mpiexec_names})
  endif()
